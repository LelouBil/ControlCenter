...
ControlCenterApi - JavaScript client for control_center_api
...
```shell
npm install control_center_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your control_center_api from, and run:
